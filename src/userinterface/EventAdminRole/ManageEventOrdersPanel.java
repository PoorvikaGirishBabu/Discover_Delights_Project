 ...
 * @author Poorvi
 */
public class ManageEventOrdersPanel extends javax.swing.JPanel {
    ...
    private Event1Directory selectedDir;


    public ManageEventOrdersPanel(JPanel userProcessContainer, EcoSystem system, EventManager eventmanager, UserAccount ua) {
        initComponents();
        ecosystem = system;
    ...
    public void viewOrderDirList() {
        ...
        for (int i = 0; i < eventmanager.getOrderDirectoryList().size(); i++) {
            for (int j = 0; j < eventmanager.getOrderDirectoryList().get(i).getOrderList().size(); j++) {
                name = eventmanager.getOrderDirectoryList().get(i).getCustomerDetails().getUsername();
            }
            ordersModel.addRow(new Object[]{
                eventmanager.getOrderDirectoryList().get(i).getId(),
                eventmanager.getOrderDirectoryList().get(i).getStatus(),
                name,
                eventmanager.getOrderDirectoryList().get(i).getComment()
            });
        }
    }
    ...
    private void initComponents() {
        ...
        AcceptButton.setBackground(new java.awt.Color(102, 102, 255));
        ...
        RejectButton.setBackground(new java.awt.Color(102, 102, 255));
    ...
    private void orderListTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_orderListTableMouseClicked
        ...
        selectedDir =  eventmanager.getOrderDirectoryList().get(orderListTable.getSelectedRow());
        
        ArrayList<EventOrder> orderlist = eventmanager.getOrderDirectoryList().get(orderListTable.getSelectedRow()).getOrderList();
