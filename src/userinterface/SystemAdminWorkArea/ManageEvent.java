 ...
 * @author Bhavya
 */
public class ManageEvent extends javax.swing.JPanel {
...
//    EcoSystem ecosystem;
     ...
     */
    public ManageEvent(JPanel userProcessContainer1, EcoSystem system) {
        initComponents();
    ...
    public void viewEventList() {
        if (ecosystem.getEventDirectory().getEventList().size() > 0) {
            for (int i = 0; i < ecosystem.getEventDirectory().getEventList().size(); i++) {
                model.addRow(new Object[]{
                    ecosystem.getEventDirectory().getEventList().get(i).getName(),
                    ecosystem.getEventDirectory().getEventList().get(i).getManagerDetails().getName(),
                    ecosystem.getEventDirectory().getEventList().get(i).getLocation(),
                    ecosystem.getEventDirectory().getEventList().get(i).getPhone(),
                    ecosystem.getEventDirectory().getEventList().get(i).getNetwork()
                });
            }
        }
    }
    ...
    public void showDeleteList() {
        for (int i = 0; i < ecosystem.getEventDirectory().getEventList().size(); i++) {
            restListCombo.addItem(ecosystem.getEventDirectory().getEventList().get(i).getName());
            updateRestListCombo.addItem(ecosystem.getEventDirectory().getEventList().get(i).getName());
    ...
    public void showComboBoxesList() {
        for (int i = 0; i < ecosystem.getEventManagerDirectory().getEventManagerList().size(); i++) {
            managerListCombo.addItem(ecosystem.getEventManagerDirectory().getEventManagerList().get(i).getName());
            updateManagerListCombo.addItem(ecosystem.getEventManagerDirectory().getEventManagerList().get(i).getName());
        }
    }
    ...
    private void initComponents() {
        ...
        addRestButton.setBackground(new java.awt.Color(102, 102, 255));
        ...
        jLabel2.setText("Delete a Event");
        ...
        jLabel4.setText("View Events");

        deleteRestButton.setBackground(new java.awt.Color(102, 102, 255));
        ...
        selectManagerLabel.setText("Select Event");
        ...
        title.setText("Welcome to Discover Delights !!");

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/CitiesGif.gif"))); // NOI18N
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {addRestButton, deleteRestButton, updateBtn});
    ...
    private void deleteRestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteRestButtonActionPerformed
        ...
        if(restListCombo.getSelectedItem() == null || restListCombo.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(null,"Select a value from dropdown of event to delete","Error message", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (flag == false) {
            Boolean isDelete = ecosystem.getEventDirectory().deleteEvent(selectedItem);
    ...
    public EventManager getCurrent(String name) {
        for (int i = 0; i < ecosystem.getEventManagerDirectory().getEventManagerList().size(); i++) {
            if (ecosystem.getEventManagerDirectory().getEventManagerList().get(i).getName().equals(name)) {
    ...
    private void addRestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addRestButtonActionPerformed
        ...
        if(managerListCombo.getSelectedItem() == null || managerListCombo.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(null,"Select a value from dropdown of event to update","Error message", JOptionPane.ERROR_MESSAGE);
            return;
        } else if (!validateFields(locationText.getText(), phoneText.getText(), restNameText.getText())) {
            return;
        }
        for (int i = 0; i < ecosystem.getEventDirectory().getEventList().size(); i++) {
            if(ecosystem.getEventDirectory().getEventList().get(i).getName() == null ? restNameText.getText() == null : ecosystem.getEventDirectory().getEventList().get(i).getName().equals(restNameText.getText())){
                JOptionPane.showMessageDialog(null,"Event Already Present", "Error message" ,JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        String managerSelectedItem = (String) managerListCombo.getSelectedItem();
        String selectedItem = (String) restListCombo.getSelectedItem();
        EventManager rm = getCurrent(managerSelectedItem);
        ecosystem.getEventDirectory().createEvent(restNameText.getText(), rm, phoneText.getText(), locationText.getText(), "Boston");
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        if(updateManagerListCombo.getSelectedItem() == null || updateManagerListCombo.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(null,"Select a value from manager dropdown of event to update","Error message", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (flag == false) {
//            Boolean isDelete = ecosystem.getRestaurantDirectory().deleteRestaurant(selectedItem);
            for (int i = 0; i < ecosystem.getEventDirectory().getEventList().size(); i++) {
                if (ecosystem.getEventDirectory().getEventList().get(i).getName().equals(selectedItem)) {
                    ecosystem.getEventDirectory().getEventList().get(i).setName(updateRestNameText.getText());
                    ecosystem.getEventDirectory().getEventList().get(i).setLocation(updateLocationText.getText());
                    ecosystem.getEventDirectory().getEventList().get(i).setPhone(updatePhoneText.getText());
                    ecosystem.getEventDirectory().getEventList().get(i).setManagerDetails(rm);
                }
            }
        }
    ...
    private void updateRestListComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateRestListComboActionPerformed
        ...
        if (updateRestListCombo.getSelectedItem() != "None") {
            String selectedItem = (String) updateRestListCombo.getSelectedItem();
            for (int i = 0; i < ecosystem.getEventDirectory().getEventList().size(); i++) {
                if (ecosystem.getEventDirectory().getEventList().get(i).getName().equalsIgnoreCase(selectedItem)) {
                    updateRestNameText.setText(ecosystem.getEventDirectory().getEventList().get(i).getName());
                    updateLocationText.setText(ecosystem.getEventDirectory().getEventList().get(i).getLocation());
                    updatePhoneText.setText(ecosystem.getEventDirectory().getEventList().get(i).getPhone());
                    break;
                }
            }
        }else{
